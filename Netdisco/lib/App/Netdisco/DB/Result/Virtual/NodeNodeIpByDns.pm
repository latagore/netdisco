use utf8;
package App::Netdisco::DB::Result::Virtual::NodeNodeIpByDns;
...
__PACKAGE__->table("node_node_ip_by_dns");
__PACKAGE__->result_source_instance->is_virtual(1);
__PACKAGE__->result_source_instance->view_definition(q{
  select ips.dns as ident, 'dns' as search_type, recent_nodes.mac, recent_nodes.switch, recent_nodes.port, recent_nodes.vlan, ips.ip, ips.dns, ips.time_first, ips.time_last from node_ip ips
  join (
